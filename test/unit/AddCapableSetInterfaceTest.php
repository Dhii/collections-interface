...
use Dhii\Collection\AddCapableSetInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since 0.2
 */
class AddCapableSetInterfaceTest extends TestCase
{
    /**
     ...
     * @since 0.2
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Collection\AddCapableSetInterface';
